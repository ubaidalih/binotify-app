  ...
  <div class="middle">
    <div class="inner">
      ...
      <p class="fail-upload" id="fail-upload"></p>
        <p><form id="mainform"  action="/binotify-app/public/detaillagu/submitedit/<?php echo $data["judul"]?>" method="POST" enctype="multipart/form-data">
...
<script src="/binotify-app/public/js/editlagu.js"></script>
</body>
</html>