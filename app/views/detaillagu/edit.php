  ...
  <div class="middle">
    <div class="inner">
      ...
      <p class="fail-upload" id="fail-upload"></p>
        <p><form id="mainform"  action="/tugas-besar-1/public/detaillagu/submitedit/<?php echo $data["judul"]?>" method="POST" enctype="multipart/form-data">
...
<script src="/tugas-besar-1/public/js/editlagu.js"></script>
</body>
</html>