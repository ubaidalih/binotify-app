  ...
  <div class="middle">
    <div class="inner">
      ...
      <p class="fail-upload" id="fail-upload"></p>
        <p><form id="mainform"  action="/tugas-besar-1/public/tambahlagu/submit" method="POST" enctype="multipart/form-data">
...
<script src="/tugas-besar-1/public/js/lagu.js"></script>
</body>
</html>