        ...
        <div class="detail-album-container">
            ...
            <div class="detail-album-info">
                ...
                <div class="button-container-3">
                    <div id="boxes"><a href="/binotify-app/public/detailalbum/edit/<?php echo $data["detail_album"][0][0]; ?>">Edit</a></div>
                    <div id="boxes"><a href="/binotify-app/public/detailalbum/delete/<?php echo $data["detail_album"][0][0]; ?> ?>">Delete</a></div>
                </div>
            </div>
        </div>
        <section>
            <div class = "button-container-2">
                <a href = "/binotify-app/public/detailalbum/tambah/<?php echo $data["detail_album"][0][0]; ?>"> Tambah Lagu </a>
                <a href = "/binotify-app/public/detailalbum/hapus/<?php echo $data["detail_album"][0][0]; ?>"> Hapus Lagu </a>
            </div>
            <h2>Songs</h2>
            ...
            <?php else:?>
                <?php foreach( $data["list_of_song"] as $index => $song ) : ?>
                    <a href="/binotify-app/public/detaillagu/admin/<?php echo $song[0] ?>">
